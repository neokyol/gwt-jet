...
public class Integer2StringBoxGenerator extends WrapperGenerator {

	/* (non-Javadoc)
	 * @see ar.com.kyol.jet.client.wrappers.WrapperGenerator#generateWrapper(ar.com.kyol.jet.client.ObjectSetter)
	 */
	@Override
	public Wrapper generateWrapper(ObjectSetter objSetter) {
		return new IntegerBoxWrapper(objSetter, true);
	}
