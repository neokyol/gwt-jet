...
public class IntegerBoxWrapper extends Wrapper {
	 ...
	 */
	public IntegerBoxWrapper(ObjectSetter objSetter) {
	 ...
	 */
	public IntegerBoxWrapper(ObjectSetter objSetter, NumericBox numericBox) {
	...
	protected Object getValor() {
		String valorInteger = IntegerBoxWrapper.this.numericBox.getText();
		if(valorInteger.isEmpty()) {
			return null;
		} else {
			return Integer.parseInt(valorInteger);
		}
	}

	@Override
	protected String getValueAsString() {
		return IntegerBoxWrapper.this.numericBox.getText();
	}
